...
public class GameFrame extends JFrame implements Runnable, KeyListener {
    ...
    public GameFrame () {
        ...
        ship = new Ship(this,pWidth/3,0,0,0,pWidth/3,pHeight,"images/boat.png");
        playarea = new PlayArea(ship.getX()+((ship.getXSize()/100)*13),0+((ship.getYSize()/100)*38),ship.getXSize()-((ship.getXSize()/100)*25),ship.getYSize()-((ship.getYSize()/100)*64));
    ...
    */
    ...
    private void gameRender(Graphics gScr){
        ...
        ship.draw((Graphics2D)gScr);
        //playarea.draw((Graphics2D)gScr);
